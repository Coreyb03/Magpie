...
public class Magpie2 {
	...
	public String getResponse(String statement) {
		...
		if (statement.indexOf("no") >= 0) {
			...
			response = "Please say something to me [T-T]";
		} else if (statement.indexOf("Car") >= 0) {
			response = "Is it fast?";
		} else if (statement.indexOf("President") >= 0) {
			response = "The US president is Donald Trump but it soon will be Joe Biden";
		}else if (statement.indexOf("2020") >= 0) {
			response = "2020 was a bad year!!!";
		}else {
