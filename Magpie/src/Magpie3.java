...
public class Magpie3 {
	...
	public String getResponse(String statement) {
		...
		if (statement.length() == 0) {
			...
			response = "Is the car fast?";
		} else if (findKeyword(statement, "President") >= 0 || findKeyword(statement, "president") >= 0) {
			response = "The president is Donald Trump but will be Joe Biden on January 20th";
		} else if (findKeyword(statement, "2020") >= 0 ) {
			response = "2020 has been a bad year!";
